    ...
    <div className="login-page">
      ...
      <div className="login-form-container">
        <div className="form-wrapper">
          ...
          <p className="form-description">Sign up if you don't have an account.</p>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="form-footer-actions">
              {/* <div className="checkbox-container">
                ...
                <p className="checkbox-text">I read and agree to Terms and Conditions and Privacy Policy.</p>
              </div> */}
              <div className="form-footer">
                <p className="signup-text">Already have an account? <Link to="/login" className="signup-link">Sign In</Link></p>
              <button type="submit" className="auth-button modern-button" disabled={loading} onClick={handleSubmit}>
